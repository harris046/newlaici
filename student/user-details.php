...
$s = mysqli_query($conn, "SELECT * FROM `tbl_user` WHERE `username`='$username'");
...
if(isset($upt)){
	...
	$e = mysqli_query($conn, "UPDATE `tbl_user` SET `fname`='$fname',`mname`='$mname',`lname`='$lname',`dob`='$dob',`gender`='$gender',`course`='$course',`yrlvl`='$yrlvl',`username`='$username',`password`='$password' WHERE `username`='$username'");
	if($e==true)
                                  {
